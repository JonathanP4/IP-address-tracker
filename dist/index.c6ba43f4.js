...
})({"jwm6s":[function(require,module,exports) {
...
var _ipView = require("./ipView");
var _ipViewDefault = parcelHelpers.interopDefault(_ipView);
...
const ipControl = async function(ip = "") {
    try {
        ...
        (0, _ipViewDefault.default).renderIpInfo(data);
    } catch (err) {
        console.error(err);
        (0, _ipViewDefault.default).renderError(`${err.message}`);
    }
};
ipControl();
const ipSearchResults = function() {
    // get ip provided by user (text input value)
    const data = (0, _ipViewDefault.default).getInputValue();
    ipControl(data);
};
const eventHandlers = function() {
    (0, _ipViewDefault.default).handleInputData(ipSearchResults);
};
eventHandlers();
const init = function() {
    (0, _mapViewDefault.default).renderMap();
};
init();

},{"./model":"Y4A21","./ipView":"aDcmp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./mapView":"6nhlg"}],"Y4A21":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "fetchIpData", ()=>fetchIpData);
...
},{}],"aDcmp":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _triangleExclamationSolidSvg = require("../images/triangle-exclamation-solid.svg");
var _triangleExclamationSolidSvgDefault = parcelHelpers.interopDefault(_triangleExclamationSolidSvg);
var _config = require("./config");
class IpView {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../images/triangle-exclamation-solid.svg":"kmdKE","./config":"k5Hzs"}],"kmdKE":[function(require,module,exports) {
module.exports = require("dc11aa9e362ac59b").getBundleURL("fgCi1") + "triangle-exclamation-solid.f4dfea0c.svg" + "?" + Date.now();

},{"dc11aa9e362ac59b":"lgJ39"}],"lgJ39":[function(require,module,exports) {
"use strict";
var bundleURL = {};
...
},{}],"6nhlg":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../images/icon-location.svg":"aXils"}],"aXils":[function(require,module,exports) {
module.exports = require("8421e61250dfde5d").getBundleURL("fgCi1") + "icon-location.f355cb28.svg" + "?" + Date.now();

},{"8421e61250dfde5d":"lgJ39"}]},["jwm6s","bznnK"], "bznnK", "parcelRequire201e")
